            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row gy-4">
                ...
                <div class="col-md-12 col-lg-4">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title mb-1">Congratulations {{session('username')}} ! 🎉</h4>
                    ...
                    <img
                      src="{{asset('assets/admin/img/icons/misc/triangle-light.png')}}"
                      class="scaleX-n1-rtl position-absolute bottom-0 end-0"
                      width="166"
                      alt="triangle background"
                      data-app-light-img="{{asset('assets/admin/img/icons/misc/triangle-light.png')}}"
                      data-app-dark-img="{{asset('assets/admin/img/icons/misc/triangle-dark.png')}}" />
                    <img
                      src="{{asset('assets/admin/img/illustrations/trophy.png')}}"
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="{{asset('assets/admin/img/avatars/3.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="{{asset('assets/admin/img/avatars/2.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="{{asset('assets/admin/img/avatars/4.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
